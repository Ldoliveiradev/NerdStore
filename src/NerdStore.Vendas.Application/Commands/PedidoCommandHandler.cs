...
namespace NerdStore.Vendas.Application.Commands
{
        ...
        IRequestHandler<CancelarProcessamentoPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(IniciarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AdicionarEvento(new PedidoIniciadoEvent(pedido.Id, pedido.ClienteId, pedido.ValorTotal, listaProdutosPedido, message.NomeCartao, message.NomeCartao, message.ExpiracaoCartao, message.CvvCartao));
        ...
        {
            if (message.Validar()) return true;
